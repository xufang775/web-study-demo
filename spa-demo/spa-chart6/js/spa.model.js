...
spa.model = (function () {
     ...
     * @type {{get_is_user: get_is_user, get_is_anon: get_is_anon}}
     */
    personProto = {
    ...
    completeLogin = function ( user_list ) {
        ...
        chat.join();
        // When web  add chat,we should join here
    ...
    people = (function () {
       ...
       get_by_cid = function (cid) {
        ...
        logout = function () {
            var user = stateMap.user;
            // when we add chat,web should leave the chatroom here
            chat._leave();
    ...
    chat = (function () {
        var
            _publish_listchange, _publish_updatchat,
        ...
        _publish_updatchat = function (arg_list) {
        ...
        join_chat = function () {
            ...
            sio.on('updatechat',_publish_updatchat);
